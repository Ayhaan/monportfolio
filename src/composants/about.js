                ...
                <div className="container mt-5 aboutme ">
                    <div className="row">
                        <div className="col-lg-6 col-md-12 col-sm-12 text-center ">
                            <img className="img" src="/img/photo-1581978846964-d3ee3ed0bed1.jpeg" alt="" />
                        </div>
                        <div className="col-lg-6 col-md-12 col-sm-12 mt-3">
                           ...
                           <hr/>
                            ...
                            <div className='text-center mt-4'>
                                <button className="btn bg-secondary mr-2 "> <a className="text-decoration-none text-white" href="#contact">ME CONTACTER</a> </button>
                                <button className='btn bg-dark ml-2 text-white'>TELECHARGER MON CV</button>
                            </div>
                            <div class="mt-4 d-flex justify-content-center">
                                <i className="fab fa-facebook-f fa-3x p-2  ml-2"></i>
                                <i className="fab fa-instagram fa-3x p-2 ml-2"></i>
                                <i class="fab fa-github fa-3x p-2  ml-2"></i>
                                {/* <i className="fas fa-laptop-code fa-3x p-2  ml-2"></i> */}
                                <i class="fab fa-linkedin-in fa-3x p-2 ml-2"></i>
                            </div>
                        </div>
                    </div>
                </div>
